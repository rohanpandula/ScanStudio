...
LS-5000 evidence from unverified LS-40/LS-50 candidates and name-only FireWire recognition. Explicit opt-in requires CoolscanPy 0.7.8; the current 0.7.7 pin still refuses unverified opens. Real B&W
