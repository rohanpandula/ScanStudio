    ...
    try:
        if spec.file_format is domain.RawExportFormat.LINEAR_DNG:
            ...
            if spec.tiff_infrared is domain.RawTiffInfrared.FOURTH_CHANNEL:
                ...
                kwargs["extratags"] = [
                    # Issue #105: the marker moved from private tag 65001,
                    # which ExifTool reports as SerialNumber for Nikon files,
                    # to the collision-free code 65010 defined next to the
                    # RGB contract.
